...
import com.example.workmysets.activities.LiveSessionActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sessionProgressWidget.setOnClickListener{
            val intent = Intent(context, LiveSessionActivity::class.java).apply {
//                putExtra()
            }
        }
    }
